...
public class PrintAdminController {
	...
	public Map<String, Object> printSet(HttpServletRequest request, HttpServletResponse response, Boolean biaoqian,
										Boolean changdu, Boolean houdu, Integer biaoqianshu, Integer baozhuangshu, Integer banzu, Integer staff, Boolean zhongliang, Boolean riqi) {
		...
		request.getServletContext().setAttribute("riqi", riqi);
